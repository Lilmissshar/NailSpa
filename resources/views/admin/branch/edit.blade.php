      ...
      <div class="card">
        ...
        <div class="row card-body">
          <div class="col-md-10 col-sm-12 mx-auto">
            {!! Form::model($branch, ['route' => ['admin.branch.update', $branch->id], 'method' => 'PUT', 'id' => 'FormValidation', 'enctype' => 'multipart/form-data']) !!}
              ...
              <div class="form-group has-label">
                ...
                {{ Form::text('location', null, ['id' => 'form-validation', 'class' => 'form-control', 'required' => 'true']) }}
              </div>
